...
namespace ET.Client
{
	...
	public  class ES_MedalExchangeTab : Entity,ET.IAwake<UnityEngine.Transform>,IDestroy 
	{
		...
		public ES_CostItemList ES_CostItemList
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			ES_CostItemList es = this.m_es_costitemlist;
     			if( es == null )

     			{
		    	   Transform subTrans = UIFindHelper.FindDeepChild<Transform>(this.uiTransform.gameObject,"Right/ES_CostItemList");
		    	   this.m_es_costitemlist = this.AddChild<ES_CostItemList,Transform>(subTrans);
     			}
     			return this.m_es_costitemlist;
     		}
     	}
		...
		private EntityRef<ES_CostItemList> m_es_costitemlist = null;
